...
bool lireFichier(int & Nr, double & mr, 
				double & Lr, double & Ur,
				double & kr, double & sr, int & nr, double & Fr, double & qr, int & Mr, int & Er, int & Dv,
				int & repsv);
void recursion(int Nv, double mv, 
				double Lv, double Uv,
				double kv, double sv, int nv, double Fv, double qv, int Mv, int Ev, int Dv,
				int repv);
